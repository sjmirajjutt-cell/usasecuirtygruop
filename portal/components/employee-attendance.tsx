...
export function EmployeeAttendance({ employeeId, initialOpen, initialHistory }: { employeeId: string; initialOpen: Attendance | null; initialHistory: Attendance[] }) {
